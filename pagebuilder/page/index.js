...
let rawBlogCode=`<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="stylesheet" href="https://galaktisk.neocities.org/data/top.css">
    <link rel="stylesheet" href="https://galaktisk.neocities.org/data/blogs/bloglist.css">
    <link rel="shortcut icon" href="../icon.png">
...
<body>
        ...
        <div class="container">
            <div class="left">
                <div class="profile">
                    ...
                    <img class="profile-icon" src="../icon.png" alt="{name}'s profile picture">
                    <div class="profile-margin"></div>
                    <a href="../" class="profile-button">View Profile</a>
                </div>
            </div>
            <div class="right">
                <h1>{name}'s Blog Entries</h1>
                <h3 class="context" id="context"></h3>
                <form action="">
                    <label for="tag">Filter for tag:</label>
    ...
    <script src="https://galaktisk.neocities.org/data/blogs/blogs.js"></script>
    <script src="https://galaktisk.neocities.org/data/navloader.js"></script>
</body>
</html>`;
    ...
    if (json) {
        ...
        reader.onload = (e) => {
            try {
                ...
                const linksData=jsonData["links"];
                nv='';
                linksData.forEach(o => {
                    nv+=`${o[0]}|${o[1]}|${o[2]}\n`;
                });
                ...
                const contactsData=jsonData["links"];
                nv='';
                contactsData.forEach(o => {
                    nv+=`${o[0]}|${o[1]}|${o[2]}\n`;
                });
                contact.value=nv;
            } catch (error) {
